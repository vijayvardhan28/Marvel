  ...
  return (
    <div className="timeline-page">
      <div className="timeline-header">
        <h1 className="page-title animate-fade-in">The <span className="text-gradient">Defenders</span></h1>
...
export default DefendersTimeline;
